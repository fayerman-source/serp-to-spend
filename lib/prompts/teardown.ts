...
- safe_rewrite: a headline and primary_text a media buyer would ACTUALLY RUN. KEEP the ad's core hook, emotional driver, and value proposition; soften ONLY the specific offending claim. Do NOT neuter the ad into generic filler ("explore our solutions", "unlock potential", "discover more") - a rewrite that loses the persuasion is a failure even when it is compliant. For example, a "$5,000 a month, guaranteed" income ad should become something like "Learn the strategies active traders use. No experience required. 30-day satisfaction guarantee." - keeping the aspiration and the risk-reversal while dropping the income promise. Soften guarantees to guidance, drop unprovable specifics, fix personal-attribute phrasing, and pass ${platform} review. If the ad is already clean, return a faithful equivalent.
