...
- safe_rewrite: a headline and primary_text that KEEP the same angle AND its persuasive hook - copy the buyer would actually run. Soften ONLY the trigger (reframe outcomes as guidance not guarantees, fix personal-attribute phrasing, drop unprovable specifics); do NOT collapse it into generic filler ("explore our solutions", "unlock potential") - a compliant but lifeless rewrite is a failure. When level is low, return a clean equivalent of the original.
