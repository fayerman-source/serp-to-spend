    ...
    <>
      ...
      <main style={{ maxWidth: MAXW, margin: "0 auto", padding: "44px 28px 0", fontFamily: sans }}>
        ...
        <Section>
          ...
          <P>
            Separately, income claims can trigger the Business Opportunity Rule (16 C.F.R. Part 437), but
            ...
            contract with an already-operating business (a vendor selling lead-generation services to an
            existing company, say) fails the &ldquo;new business&rdquo; element even if it happens to
            also promise customers. Pure coaching, courses, or general business-development training do not
            count on their own, but specific advice or training on how to obtain accounts or customers
            ...
            a Section 5 substantiation matter, not automatically a Part 437 violation, unless it also
        ...
        <Section>
          ...
          <P>
            ...
            (16 C.F.R. § 255.1(d)). Running an offer through affiliates does not move the substantiation
