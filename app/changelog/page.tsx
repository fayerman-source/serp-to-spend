...
const LOG: Array<{ date: string; items: Array<{ k: string; n: ReactNode }> }> = [
  ...
  },
  {
    date: "June 26, 2026",
    items: [
      { k: "refactor", n: "Refactored the tool UI into focused components (a thin orchestrator plus result and section modules), shared the API types from one schema, and made the layout mobile-responsive." },
  ...
  },
  {
    date: "June 27, 2026",
    items: [
      { k: "domain", n: "Launched on its own domain at serptospend.com, with an Open Graph card so shared links render a real preview instead of a bare title." },
    ],
  },
];
